...
function renderCart() {
    ...
    if(cart.length === 0){
        ...
        messageCart.textContent = "Tu carrito esta vacio"
        ...
        cart.forEach(items => {
            ...
            itemElements.innerHTML = ` 
                ...
                <span class="spanNombre">Descripción: ${items.name} - $${items.price} x ${items.cantidadComprada} = $${items.price * items.cantidadComprada}</span>
