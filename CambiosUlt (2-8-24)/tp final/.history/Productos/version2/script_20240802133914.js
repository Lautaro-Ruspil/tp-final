...
function renderProducts() {
    ...
    for (let i = 0; i < products.length; i++) {
        ...
        productElement.innerHTML += `
                ...
                <input type="number" class="input" id="cantidad${product.id}" placeholder="Cantidad" min="0" max="${product.stock}">
...
function cargarClick(){
    ...
    botones.forEach(element => {
        element.addEventListener("click", (e) => {
            ...
            let cantInput = document.querySelectorAll(`#cantidad${productId}`);
