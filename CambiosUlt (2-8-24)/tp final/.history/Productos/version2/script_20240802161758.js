...
function cargarClick(){
    ...
    let buttonReturn = document.querySelectorAll(".btnDevolver");
...
function renderCart() {
    ...
    for(let i = 0 ; i < cart.length ; i++){
        ...
        let texto = document.createTextNode(`${items.name} - $${items.price} x ${items.cantidadComprada} = $${items.price * items.cantidadComprada}`);
