...
let total = 0 ;
    ...
    function renderProducts() {
        ...
        for(let i = 0 ; i < products.length ; i++){
            ...
            productElement.innerHTML = `
                ...
                <input type= "number" class= "input" name="cantidad" placeholder="Cantidad" min="0" max="${product.stock}" value="0">
    ...
    function renderCart() {
        ...
        //control de stock
            ...
            let cantidad = document.getElementsByClassName("input").value;
            cantidad = Number(cantidad);
            if((cantidad > 0 && products.stock - cantidad) >= 0){
                let total = 0;
                total += products.price * cantidad;
                console.log(total);
            }
        }
