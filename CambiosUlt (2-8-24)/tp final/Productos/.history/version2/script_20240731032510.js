...
function renderProducts(products) {
    ...
    for(let i = 0 ; i < products.length ; i++){
        ...
        productElement.innerHTML = `
            <img src="c:\Users\Usuario\OneDrive\Escritorio\Olavarria Full Stack\HTML\HTML Full Stack\Clases JavaScript\tp final\Productos\version2\imgProducts${product.id}.png">
            <h2>${product.name}</h2>
            <p></p>
        `
