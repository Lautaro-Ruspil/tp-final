...
function renderProducts(products) {
    ...
    for(let i = 0 ; i < products.length ; i++){
        ...
        productElement.innerHTML = `
            <img src="C:\Users\Usuario\OneDrive\Escritorio\Olavarria Full Stack\HTML\HTML Full Stack\Clases JavaScript\tp final\Productos\version2\imagenes Productos${product.id}.png">
            <h2>${product.name}</h2>
            <p></p>
        `
