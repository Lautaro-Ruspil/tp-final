...
//funcion para cargar card ofertas
function renderProductsOferts(){
    ...
    for(let i = 0 ; i < products.length ; i++){
        ...
        productElement.classList.add("container-item");
        productElement.innerHTML = `
            ...
            <p class= "precioAnterior">Precio: <span class="tachado">$${product.price}</span></p>
...
//inicializo las card en ofertas
renderProductsOferts()