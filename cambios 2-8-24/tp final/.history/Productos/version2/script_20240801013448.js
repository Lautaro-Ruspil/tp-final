...
let total = 0 ;
    ...
    function addToCart(productsIndex){
        ...
        let cantidad = document.querySelector(".input");
    ...
    function renderCart() {
        ...
        let total1 = 0;
            ...
            let cantidad = document.getElementsByClassName("input");
            let Acantidad = parseInt(cantidad.value);
            console.log(typeof Acantidad);
            if(Acantidad > 0 && products.stock >= 0){
                total1 += products.price * Acantidad;
                console.log(total1);
            }
        }
        /*let arrayproducts = [];
