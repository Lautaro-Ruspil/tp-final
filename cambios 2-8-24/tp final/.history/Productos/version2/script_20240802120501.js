...
function renderProducts() {
    ...
    cargarClick(botones , buttonsReturn);
}

renderProducts();


function cargarClick(botones){

    botones.forEach(element => {
        element.addEventListener("click", (e) => {
            let input = e.target.previousElementSibling.value;
            addToCart(products[e.target.id - 1],input , botones)
        })
...
function addToCart(productsIndex, cantidad , botones) {
