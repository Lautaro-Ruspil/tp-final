...
let total = 0 ;
    ...
    function renderProducts() {
        ...
        for(let i = 0 ; i < products.length ; i++){
            ...
            productElement.innerHTML += `
                ...
                <input  data-index="${product.id} " type= "number" id="input" class= "input" name="cantidad" placeholder="Cantidad" min="0" max="${product.stock}">
    ...
    function addToCart(productsIndex){
        ...
        let cantidad = document.querySelector(`#${productsIndex}`);
